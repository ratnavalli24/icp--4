...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void translateText(View v) {
        TextView langTextView = (TextView) findViewById(R.id.txt_lname);
        langText = langTextView.getText().toString();
        TextView convertTextView = (TextView) findViewById(R.id.txt_cname);
        convertText = convertTextView.getText().toString();
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang="+langText+"-"+convertText+"&[format=plain]&[options=1]&[callback=set]";//The API service URL
